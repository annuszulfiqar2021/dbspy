...
from dbspy.indexed_zset import IndexedZSet, sort_merge_join
...
def join_with_index[T, I, R, S](
    ...
    right_indexed_zset: IndexedZSet[I, T],
    f: PostSortMergeJoinProjection[I, T, R, S]
) -> ZSet[S]:
    """
        Joins two ZSets. Takes advantage of the B-Tree indexes and is implemented as sort-merge join
